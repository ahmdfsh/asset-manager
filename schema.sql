-- ============================================================
-- AssetPro — Supabase Schema
-- Jalankan seluruh file ini di Supabase SQL Editor
-- ============================================================

-- ENUM TYPES
CREATE TYPE asset_status AS ENUM ('Aktif', 'Dalam Servis', 'Tidak Aktif');
...
CREATE TABLE users (
  ...
  password    TEXT NOT NULL,         -- simpan hash di produksi!
...
CREATE TABLE assets (
  id            BIGSERIAL PRIMARY KEY,
  code          TEXT NOT NULL UNIQUE,       -- AST-001
  name          TEXT NOT NULL,
  category      TEXT NOT NULL,
  location      TEXT NOT NULL,
  pic           TEXT,                       -- pengguna / PIC
  status        asset_status NOT NULL DEFAULT 'Aktif',
  book_value    TEXT,                       -- Rp 8,5jt (display)
  serial_number TEXT,
  brand_model   TEXT,
  specs         TEXT,
  purchase_date DATE,
...
CREATE TABLE work_orders (
  id            BIGSERIAL PRIMARY KEY,
  wo_number     TEXT NOT NULL UNIQUE,       -- WO-0089
  asset_id      BIGINT REFERENCES assets(id) ON DELETE SET NULL,
  asset_name    TEXT NOT NULL,              -- denormalized untuk display
...
CREATE TABLE components (
  id          BIGSERIAL PRIMARY KEY,
  code        TEXT NOT NULL UNIQUE,         -- CMP-001
  name        TEXT NOT NULL,
  category    TEXT,
  rack        TEXT,
...
CREATE TABLE transfers (
  id              BIGSERIAL PRIMARY KEY,
  transfer_number TEXT NOT NULL UNIQUE,     -- TRF-001
  asset_id        BIGINT REFERENCES assets(id) ON DELETE SET NULL,
...
CREATE TABLE purchase_orders (
  id          BIGSERIAL PRIMARY KEY,
  po_number   TEXT NOT NULL UNIQUE,         -- PO-2026-047
